...
const Post = () => {
  return (
    <Link href="/1">
      <div className="w-full flex gap-6 pb-8 border-b border-gray-300">
        <div className="flex-col gap-3">
          ...
          <p>
            ...
            문제를 네이버의 현업 엔지니어와 함께 아이디어 설계 단계부터 기
          </p>
        ...
        <Image src="/ex.png" alt="Example Image" width={220} height={120} />
      </div>
    </Link>
  );
};
